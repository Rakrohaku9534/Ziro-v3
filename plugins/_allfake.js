...
[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'rakeohaku@gmail.com', true],
]
...
/* Fake Reply */
function Fakes() {
    let Org = pickRandom(["0", "447389661153", "6288906250517", "6282195322106", "6281119568305", "6281282722861", "6281228070013"])
    let Parti = pickRandom([Org + "@s.whatsapp.net", Org + "@c.us"])
    let Remot = pickRandom(["status@broadcast", "120363164474799719@g.us"])
